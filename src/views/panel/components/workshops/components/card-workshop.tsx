...
const CardWorkshop = ({ title, date, location, src_speaker, src_workshop }: Props) => {
    return (
            ...
            <div className="flex w-full items-center gap-x-8">
                ...
                <div className="flex flex-col sm:flex-row lg:flex-col gap-y-4 items-center lg:items-start gap-x-4">
                    <div className="flex flex-col gap-y-1">
                        ...
                        <p className="text-white/80 text-xs md:text-sm lg:text-base ">{date}</p>
                        <p className="text-white/80 text-xs md:text-sm lg:text-base ">{location}</p>
                    </div>
                    <div className="w-full sm:w-min">
                        <button className="px-6 py-1 sm:px-6 sm:py-2 w-full text-sm sm:text-base bg-[#FAAEF1] font-semibold hover:font-bold hover:bg-[#AAAEF1] transition-colors rounded-full uppercase tracking-wider text-[#333333]">Inscribirse</button>
                    </div>
                </div>
            </div>
