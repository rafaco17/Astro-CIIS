...
const CardWorkshop = ({ title, date, location, price, src_speaker, src_workshop }: Props) => {
  const handleClick = () => {
    //location.href = "/app";
  }

  return (
      <div className="flex max-h-[300px] overflow-hidden border border-white/30 rounded-sm max-w-4xl hover:scale-105 group flex-col lg:flex-row px-2 py-4 sm:pl-6 sm:py-2 sm:px-1 lg:px-0 lg:py-0 lg:pl-8 pb-8">
          <div className="flex w-full items-center gap-x-8">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-y-4 items-center lg:items-start gap-x-4">
                  <div className="flex flex-col gap-y-1">
                      ...
                      <p className="text-white/80 text-xs md:text-sm lg:text-base ">13/11/2024</p>
                      <p className="text-white/80 text-xs md:text-sm lg:text-base ">11:00 - 12:30</p>
                      <p className="text-white/80 text-xs md:text-sm lg:text-base ">{location}</p>
                      <p className="text-white/80 text-xs md:text-sm lg:text-base ">S/.{price}</p>
                      <p></p>
                  </div>
