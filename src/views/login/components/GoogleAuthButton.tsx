...
export function GoogleAuthButton({ text, disabled = false, handleClick }: Props) {
    return (
        <>
            <button 
                className="w-4/5 sm:w-3/5 px-2 sm:px-3 py-2.5 mt-1 rounded-md bg-white border-none outline-none flex justify-center items-center" 
                style={{boxShadow: "rgb(0 0 0 / 20%) 0px 3px 1px -2px, rgb(0 0 0 / 14%) 0px 2px 2px 0px, rgb(0 0 0 / 12%) 0px 1px 5px 0px"}}
                onClick={handleClick}
                disabled={disabled}
                >
                ...
                <span className="ml-2.5 text-[#2c444e]">{text}</span>
            </button>
        </>
    )
}
